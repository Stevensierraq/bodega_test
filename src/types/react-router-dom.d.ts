...
function Redirect(_ref: any): any;
namespace Redirect {
  namespace propTypes {
...
function generatePath(path: any, params: any): any;
function matchPath(pathname: any, options: any): any;
